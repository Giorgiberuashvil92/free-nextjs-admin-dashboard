...
export default function EditCarRentalPage() {
  ...
  useEffect(() => {
    const loadCar = async () => {
      try {
        ...
        setError("მანქანის ჩატვირთვა ვერ მოხერხდა");
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiPut(`/car-rental/${id}`, payload);
      router.push("/car-rentals");
    } catch (e: unknown) {
      const msg = e && typeof e === "object" && "message" in e 
        ? String((e as { message?: string }).message) 
        : "შეცდომა მანქანის განახლებისას";
      setError(msg);
      console.error(e);
    } finally {
      setLoading(false);
  ...
  return (
    <div className="p-6 max-w-4xl">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">განაახლეთ მანქანის ინფორმაცია</p>
      </div>
