              ...
              onClick={async () => {
                ...
                try {
                  ...
                  const res = await fetch(`${API_BASE}/notifications/broadcast`, {
                    ...
                    body: JSON.stringify({
                      title: '🚀 წლის ყველაზე დიდი ავტო-გამოწვევა დაიწყო! მოიგე 200ლ საწვავი ⛽ ! ',
                      body: 'MARTE-ს ახალი კამპანია იწყება! გახდი გამარჯვებული 3 მარტივ ნაბიჯში: 1️⃣ განაახლე აპლიკაცია 2️⃣ დააჭირე მთავარ ბანერს 3️⃣ გაუზიარე შენი უნიკალური კოდი მეგობრებს და დაარეგისტრირე. 1 მეგობარი = 100 ქულა. 1 თვეში ტოპ მძღოლი 200 ლიტრით დასაჩუქრდება! 🏎️💨',
                      data: {
                        type: 'welcome',
