                ...
                try {
                  ...
                  const res = await fetch(`${API_BASE}/notifications/broadcast`, {
                    ...
                    body: JSON.stringify({
                      ...
                      body: '200 ლიტრი საწვავის გათამაშება დაიწყო, გაიაქტიურე პრემიუმ პაკეტი 2.99-ად , ჩაერთე გათამაშებაში და მიიღე 5 კარფაქსი უფასოდ, მოიწვიე მეგობრები აპლიკაციაში და გახდი გამარჯვებული!',
                      data: {
                        type: 'welcome',
