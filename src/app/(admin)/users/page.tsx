  ...
  useEffect(() => {
    const loadPlatformStats = async () => {
      ...
      try {
        ...
        const res = await fetch(`${API_BASE}/notifications/platform-stats?t=${Date.now()}`, {
          cache: "no-store",
          headers: { 'Cache-Control': 'no-cache' }
        });
    ...
    <div className="space-y-6">
      ...
      {platformStats && (
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">📱 Platform სტატისტიკა</h2>
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  const res = await fetch(`${API_BASE}/notifications/broadcast`, {
                    ...
                    body: JSON.stringify({
                      title: '🚀  მოიგე 200ლ საწვავი ⛽ ! ',
                      body: '200 ლიტრი საწვავის გათამაშება დაიწყო, გაიაქტიურე პრემიუმ პაკეტი 3.99-ად , ჩაერთე გათამაშებაში და მიიღე 1 კარფაქსი უფასოდ, მოიწვიე მეგობრები აპლიკაციაში და გახდი გამარჯვებული!',
                      data: {
                        type: 'welcome',
