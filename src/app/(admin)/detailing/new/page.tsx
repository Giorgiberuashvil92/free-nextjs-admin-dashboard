...
export default function NewDetailingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        title: form.title,
        type: "დითეილინგი", // Fixed type for detailing
  ...
  return (
    <div className="p-6 max-w-2xl">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">ახალი დითეილინგ მაღაზია</h1>
        <p className="text-gray-600 mt-1">შეიყვანეთ დითეილინგ მაღაზიის ინფორმაცია</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="მაგ. Premium Detailing"
            required
          />
        </div>
